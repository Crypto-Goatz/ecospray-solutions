...
export function SiteImportStep({
        ...
        {tab === "url" && (
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={!url.trim()}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white text-sm font-medium rounded-lg disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <div className="space-y-4">
            <div>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white text-sm font-medium rounded-lg transition-colors"
              >
    ...
    return (
      <div className="py-12 text-center space-y-6">
        ...
        {phase === "analyzing" && crawlInfo.pageCount && (
          <div className="max-w-xs mx-auto bg-zinc-800 border border-zinc-700 rounded-lg p-4 text-left">
            <p className="text-xs text-zinc-500 mb-2">Crawl summary:</p>
      ...
      <div className="space-y-6">
        ...
        {content?.businessInfo && (
          <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4 space-y-2">
            <h3 className="text-sm font-semibold text-zinc-300">Business Info</h3>
  ...
  return (
    <div className="py-12 text-center space-y-6">
      ...
      <button
        onClick={handleDone}
        className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-medium rounded-lg transition-colors"
      >
        Continue Setup
        <ArrowRight className="w-4 h-4" />
      </button>
