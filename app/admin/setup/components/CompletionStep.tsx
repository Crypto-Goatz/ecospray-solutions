...
import { CheckCircle2, ExternalLink, Loader2, Leaf, AlertCircle } from "lucide-react";
    ...
    return (
      <div className="text-center space-y-6">
        ...
        <div className="space-y-3 text-left max-w-sm mx-auto">
          <a
            href="/admin"
            className="flex items-center justify-between rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-3 text-white hover:bg-zinc-700 transition-colors"
          >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-zinc-700 bg-zinc-800 p-4 space-y-3">
        <p className="text-sm font-medium text-white">This will:</p>
      ...
      <button
        ...
        disabled={finishing}
        className="w-full rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 py-3 text-white font-semibold transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
      >
        {finishing ? (
          <>
