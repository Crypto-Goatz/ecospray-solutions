  ...
  async function handleFinish() {
    ...
    await callApi("save-config", {
      ...
      config: {
        ...
        primary_color: state.branding.primary || "#22c55e",
        secondary_color: state.branding.secondary || "#059669",
        accent_color: state.branding.accent || "#10b981",
    ...
    const envVars: Record<string, string> = {
      ...
      NEXT_PUBLIC_COLOR_PRIMARY: state.branding.primary || "#22c55e",
      NEXT_PUBLIC_COLOR_SECONDARY: state.branding.secondary || "#059669",
      NEXT_PUBLIC_COLOR_ACCENT: state.branding.accent || "#10b981",
    };
