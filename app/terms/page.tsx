...
export const metadata = {
  title: "Terms of Service | EcoSpray Solutions",
  description: "Terms of service for EcoSpray Solutions spray foam insulation services.",
}
      ...
      <section className="pt-24 pb-20 md:pt-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert prose-zinc max-w-none space-y-6 text-zinc-300">
            ...
            <p>By accessing and using the EcoSpray Solutions website (&quot;ecospraysolutions.com&quot;), you accept and agree to be bound by these Terms of Service. If you do not agree, please do not use our website.</p>

            <h2 className="text-xl font-semibold text-white mt-8">2. Services</h2>
            <p>EcoSpray Solutions provides spray foam insulation services for residential and commercial properties in the greater Pittsburgh, PA area. All services are subject to a separate service agreement and proposal.</p>
            ...
            <p>All content on this website, including text, images, logos, and design, is owned by EcoSpray Solutions and protected by copyright law. You may not reproduce, distribute, or create derivative works without our written permission.</p>

            <h2 className="text-xl font-semibold text-white mt-8">6. Limitation of Liability</h2>
            <p>EcoSpray Solutions makes no warranties about the accuracy or completeness of website content. We shall not be liable for any indirect, incidental, or consequential damages arising from your use of the website.</p>

            <h2 className="text-xl font-semibold text-white mt-8">7. Warranty</h2>
            <p>All insulation work performed by EcoSpray Solutions comes with a lifetime workmanship warranty. Material warranties are provided by the respective manufacturers. Warranty details will be included in your service agreement.</p>
