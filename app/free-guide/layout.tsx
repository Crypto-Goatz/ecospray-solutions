...
export const metadata: Metadata = {
  title: "Free Guide: The Pittsburgher's Guide to a Draft-Free Home | EcoSpray Solutions",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://ecospraysolutions.com/free-guide",
    images: [
      {
        url: "/images/logos/banner-worker.png",
        width: 1200,
        height: 630,
        alt: "EcoSpray Solutions - Free Insulation Guide",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://ecospraysolutions.com/free-guide",
  },
}
